...
class SystemConfigControllerTest {
    ...
    @BeforeEach
    void setUp() {
        ollamaAdapter = new OllamaAdapter(RestClient.builder(), "http://localhost:11434", "qwen2.5-coder", "qwen2.5-coder,llama3");
    ...
    void getSystemConfig_shouldReturnActiveBackendConfigAndAvailableModels() {
        ResponseEntity<SystemConfigResponseDto> response = controller.getSystemConfig();
