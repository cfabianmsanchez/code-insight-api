...
class AnalyzeRepositoryControllerTest {
  ...
  void analyzeGithubRepository_shouldReturnAnalysisResult() throws Exception {
    ...
    when(
      analyzeRepositoryUseCase.analyzeRepository(any(FetchCodeRequest.class))
    ...
    mockMvc
      ...
      .andExpect(
        jsonPath("$.technologyStack.mainFramework").value("Spring Boot")
      );
  }
