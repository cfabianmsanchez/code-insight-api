...
public final class ArchitectureDetectionRules {
   ...
   */
  public static final Set<String> TEST_FILE_SUFFIXES_PYTHON = Set.of(
    "_test.py"
  );
   ...
   */
  public static final Set<String> MOBILE_FRAMEWORKS = Set.of("Ionic");
   ...
   */
  public static final List<FrontendFrameworkRule> FRONTEND_FRAMEWORK_RULES =
    List.of(
