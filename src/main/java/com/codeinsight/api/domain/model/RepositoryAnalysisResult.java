...
public class RepositoryAnalysisResult {
  ...
  /** Resumen funcional del propósito del repositorio generado por el LLM. */
  private String functionalSummary;
  /** Nombre del modelo de IA utilizado para este análisis específico. */
  ...
  public ComponentAnalysisResult getComponentAnalysis() {
    return componentAnalysis;
  }

  public ArchitectureEvidenceResult getArchitectureEvidence() {
  ...
  public static class Builder {
    ...
    public Builder technologyStack(TechnologyStack technologyStack) {
      this.technologyStack = technologyStack;
      return this;
    }

    public Builder componentAnalysis(
      ComponentAnalysisResult componentAnalysis
    ) {
      this.componentAnalysis = componentAnalysis;
      return this;
    ...
    public Builder architectureEvidence(
      ArchitectureEvidenceResult architectureEvidence
    ) {
      this.architectureEvidence = architectureEvidence;
      return this;
    ...
    public Builder analysisContext(AnalysisContext analysisContext) {
      this.analysisContext = analysisContext;
      return this;
    }

    public Builder aiSynthesis(String aiSynthesis) {
      this.aiSynthesis = aiSynthesis;
      return this;
    }

    public Builder functionalSummary(String functionalSummary) {
      this.functionalSummary = functionalSummary;
      return this;
    }
