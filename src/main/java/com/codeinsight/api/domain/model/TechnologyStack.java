...
public class TechnologyStack {
  ...
  public List<String> getDatabasesDetected() {
    return databasesDetected;
  }

  public List<String> getKeyLibraries() {
    return keyLibraries;
  }
  ...
  public static class Builder {
    ...
    public Builder mainLanguage(String mainLanguage) {
      this.mainLanguage = mainLanguage;
      return this;
    }

    public Builder mainFramework(String mainFramework) {
      this.mainFramework = mainFramework;
      return this;
    }
    ...
    public Builder databasesDetected(List<String> databasesDetected) {
      this.databasesDetected = databasesDetected;
      return this;
    }

    public Builder keyLibraries(List<String> keyLibraries) {
      this.keyLibraries = keyLibraries;
      return this;
    }
