...
public class FetchCodeRequest {
    ...
    public FetchCodeRequest(String projectKey, SourceType sourceType, String repoUrl, InputStream zipInputStream) {
    ...
    public InputStream getZipInputStream() { return zipInputStream; }
    public void setZipInputStream(InputStream zipInputStream) { this.zipInputStream = zipInputStream; }
    ...
    public static class Builder {
        ...
        public Builder zipInputStream(InputStream zipInputStream) { this.zipInputStream = zipInputStream; return this; }

        public FetchCodeRequest build() {
            return new FetchCodeRequest(projectKey, sourceType, repoUrl, zipInputStream);
        }
    }
}
