...
public class AnalysisResponseDto {
    ...
    public AnalysisResponseDto(String id, String projectKey, String analysisType, int linesOfCode,
    ...
    public static class Builder {
        ...
        public AnalysisResponseDto build() {
            return new AnalysisResponseDto(id, projectKey, analysisType, linesOfCode, cyclomaticComplexity,
