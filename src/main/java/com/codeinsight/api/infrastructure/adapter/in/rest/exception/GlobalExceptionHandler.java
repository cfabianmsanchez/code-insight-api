...
public class GlobalExceptionHandler {
  ...
  > handleMaxUploadSizeExceededException(MaxUploadSizeExceededException ex) {
    ...
    body.put(
      "message",
      "El archivo comprimido excede el tamaño máximo permitido (500MB)."
    );
  ...
  @ExceptionHandler({
    ...
    UnsupportedSourceTypeException.class,
    IllegalArgumentException.class,
  })
  public ResponseEntity<Map<String, Object>> handleBadRequestDomainExceptions(
    Exception ex
  ) {
    Map<String, Object> body = new HashMap<>();
    body.put("timestamp", LocalDateTime.now());
  ...
  @ExceptionHandler({
    RepositoryFetchException.class,
    RepositoryScanningException.class,
  })
  public ResponseEntity<
    Map<String, Object>
  > handleUnprocessableDomainExceptions(DomainException ex) {
  ...
  public ResponseEntity<Map<String, Object>> handleGenericDomainException(
    DomainException ex
  ) {
